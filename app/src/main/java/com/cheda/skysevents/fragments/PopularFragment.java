...
import com.cheda.skysevents.adapters.SkyEventsListAdapter2;
...
import com.cheda.skysevents.service.RequestInterface2;
...
/**
 * Created by Cheda on 2017-07-01.
 */

public class PopularFragment extends Fragment implements SearchView.OnQueryTextListener{
    private RecyclerView mRecycler;
    // public SkyEventsListAdapter.FavListener mFavlistener;
    private ArrayList<SkyEvent> mArrayList;
    public SkyEventsListAdapter2 mAdapter;
    private SwipeRefreshLayout swipeContainer;
    private SkyListCallback listCallb;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecycler = (RecyclerView)v.findViewById(R.id.fragment_popular);
    ...
    public void loadJSON(){
        ...
        RequestInterface2 request = Client.getClient().create(RequestInterface2.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                mAdapter = new SkyEventsListAdapter2(getContext(), mArrayList,listCallb ,new SkyEventsListAdapter2.FavListener() {
                    @Override
...
//    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof UpComingFragment.SkyListCallback) {
            listCallb = (SkyListCallback) context;
        } else {
    ...
    public interface SkyListCallback {
        ...
        void onSkyEvent2Selected(SkyEvent event);
    }
