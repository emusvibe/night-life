...
import com.cheda.skysevents.startscreen.util.signincontainer.SmartLockBase;
...
public class AuthUI {
    ...
    /**
     * Default theme used by  if no theme customization is
     * required.
     */
    @StyleRes
...
//        }
         ...
         */
        public T setSmartLockEnabled(boolean enabled) {
